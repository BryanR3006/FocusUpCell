...
const ProgressCircle = ({ percentage, size = 140 }) => {
  ...
  const getProgressLabel = (progress: number) => {
    if (progress === 20) return 'Primer repaso';
    if (progress === 40) return 'Segundo repaso';
    if (progress === 60) return 'Tercer repaso';
    if (progress === 80) return 'Cuarto repaso';
...
const SpacedRepetitionStepsView: React.FC = () => {
  ...
  const steps = [
    {
      ...
      description: "Realiza tu primer contacto con el material de estudio.",
      instruction: "Lee y comprende el material completamente. Toma notas y identifica los conceptos clave.",
      interval: "Ahora mismo",
      icon: BookOpen,
    },
    {
      id: 1,
      title: "2. Primer Repaso 🔄",
      description: "Refuerza lo aprendido después de un breve intervalo.",
      instruction: "Revisa tus notas y trata de recordar los conceptos principales sin mirar el material.",
      interval: "1-2 horas después",
      icon: Clock,
    },
    {
      id: 2,
      title: "3. Segundo Repaso ⏰",
      description: "Consolida el aprendizaje después de un día.",
      instruction: "Intenta explicar los conceptos en voz alta o escribir un resumen sin ayuda.",
      interval: "24 horas después",
      icon: Calendar,
    },
    {
      id: 3,
      title: "4. Tercer Repaso 📅",
      description: "Fortalecimiento a medio plazo del conocimiento.",
      instruction: "Resuelve ejercicios prácticos o aplica los conceptos en situaciones reales.",
      interval: "3 días después",
      icon: Bell,
    },
    {
      id: 4,
      title: "5. Repaso Final ✅",
      description: "Consolidación final para retención a largo plazo.",
      instruction: "Realiza una autoevaluación completa y revisa cualquier punto débil.",
      interval: "1 semana después",
      icon: CheckCircle,
    },
  ];
    ...
    const fetchMethodData = async () => {
      try {
        ...
        const mockMethod: StudyMethod = {
          ...
          descripcion: 'Método de repaso en intervalos crecientes',
  ...
  const startSession = async () => {
    try {
      ...
      Alert.alert('Éxito', `Sesión de ${method?.titulo || 'Repaso Espaciado'} iniciada correctamente`);
    } catch (error) {
      console.error('Error starting session:', error);
      Alert.alert('Error', 'Error al iniciar la sesión de Repaso Espaciado');
    }
  };
  ...
  const finishMethod = async () => {
    ...
    Alert.alert(
      '¡Completado!',
      `Sesión de ${method?.titulo || 'Repaso Espaciado'} guardada correctamente`,
      [
        {
          text: 'OK',
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.stepCard}>
          <View style={styles.stepHeader}>
            ...
            <View style={styles.stepTitleContainer}>
              ...
              <View style={styles.intervalBadge}>
                <Text style={styles.intervalText}>{currentStepData.interval}</Text>
              </View>
            </View>
          </View>
          ...
          {currentStep === 0 && (
            <View style={styles.tipCard}>
              ...
              <Text style={styles.tipText}>
                <Text style={styles.tipBold}>Consejo:</Text> Toma notas activas, no solo copies. Reformula los conceptos con tus propias palabras.
              </Text>
            </View>
          )}
          ...
          {currentStep === 4 && (
            <View style={styles.tipCard}>
              <Text style={styles.tipEmoji}>🎯</Text>
              <Text style={styles.tipText}>
                <Text style={styles.tipBold}>Recordatorio:</Text> Programa recordatorios para tus próximos repasos usando la función de alarmas de la app.
              </Text>
            </View>
          )}
        </View>
        ...
        {/* Recordatorio científico */}
        <View style={styles.reminderCard}>
          <Text style={styles.reminderEmoji}>🧠</Text>
          <Text style={styles.reminderText}>
            <Text style={styles.reminderBold}>Base científica:</Text> El repaso espaciado aprovecha la "curva del olvido" de Ebbinghaus. Los intervalos crecientes fortalecen las conexiones neuronales de manera más efectiva que el estudio masivo.
          </Text>
        </View>
...
// Los estilos son similares a los de MindMapsStepsView pero con colores morados
// Puedes reutilizar los mismos estilos adaptando los colores
