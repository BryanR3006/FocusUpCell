...
export const CornellIntroView: React.FC = () => {
    ...
    const fetchMethodData = async () => {
      try {
        ...
        const mockMethod: StudyMethod = {
          ...
          beneficios: [
            { id_beneficio: 1, descripcion_beneficio: 'Mejora la organización de notas' },
            { id_beneficio: 2, descripcion_beneficio: 'Facilita la revisión del material' },
            { id_beneficio: 3, descripcion_beneficio: 'Aumenta la retención de información' },
            { id_beneficio: 4, descripcion_beneficio: 'Optimiza el tiempo de estudio' }
          ]
        };
  ...
  const handleStartMethod = () => {
    navigation.navigate('CornellSteps', { methodId });
  };
    ...
    return (
      <SafeAreaView style={styles.loadingContainer}>
        ...
        <View style={styles.loadingContent}>
          ...
          <Text style={styles.loadingSubtitle}>Preparando el método Cornell</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  const steps = [
    {
      icon: PenTool,
      title: '1. Tomar notas',
      description: 'Divide tu página en secciones: área principal para notas, columna izquierda para palabras clave, y parte inferior para el resumen.',
      color: '#3B82F6'
    },
    {
      icon: CheckCircle,
      title: '2. Palabras clave',
      description: 'Identifica las ideas principales y palabras clave más importantes. Escríbelas en la columna izquierda para facilitar la revisión.',
      color: '#2563EB'
    },
    {
      icon: FileText,
      title: '3. Resumen',
      description: 'Redacta un resumen breve de 3-5 frases que capture los puntos más importantes de tus notas para reforzar el aprendizaje.',
      color: '#1D4ED8'
    },
    {
      icon: BookOpen,
      title: '4. Revisión',
      description: 'Usa las palabras clave para hacer preguntas y revisar el material. Cubre las notas para probar tu memoria y comprensión.',
      color: '#1E40AF'
    }
  ];
      ...
      >
        ...
        >
          ...
          <View style={styles.headerTitle}>
            <Text style={styles.headerTitleText}>Método Cornell</Text>
          </View>
        ...
        >
          ...
          <View style={styles.heroContent}>
            <View style={[styles.methodBadge, { backgroundColor: 'rgba(59, 130, 246, 0.2)', borderColor: 'rgba(59, 130, 246, 0.3)' }]}>
              <PenTool size={20} color="#3B82F6" />
              <Text style={[styles.methodBadgeText, { color: '#3B82F6' }]}>Método Cornell</Text>
            </View>

            <View style={styles.methodImageContainer}>
              <View style={[styles.methodImage, styles.methodImageFallback, { backgroundColor: 'rgba(59, 130, 246, 0.2)', borderColor: 'rgba(59, 130, 246, 0.3)' }]}>
                <Text style={styles.methodEmoji}>📝</Text>
              </View>
            </View>

            <Text style={styles.heroTitle}>Organiza tus Notas</Text>
            ...
            <View style={styles.featuresContainer}>
              <View style={styles.featureTag}>
                ...
                <Text style={styles.featureText}>Notas Estructuradas</Text>
              </View>
              <View style={styles.featureTag}>
                <View style={[styles.featureDot, { backgroundColor: '#2563EB' }]} />
                <Text style={styles.featureText}>Mejor Organización</Text>
              </View>
              <View style={styles.featureTag}>
                <View style={[styles.featureDot, { backgroundColor: '#1D4ED8' }]} />
                <Text style={styles.featureText}>Revisión Eficaz</Text>
              </View>
            </View>
          </View>
        </Animated.View>
        ...
        >
          ...
          >
            <Text style={styles.startButtonText}>Comenzar Método Cornell</Text>
            <ArrowLeft 
              size={20} 
              color="#FFFFFF" 
